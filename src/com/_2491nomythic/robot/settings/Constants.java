...
public class Constants {
	//Drive
	public static final int driveTalonLeftChannel = 10;
	public static final int driveTalonCenterLeftChannel = 11;
	public static final int driveTalonCenterRightChannel = 12;
	public static final int driveTalonRightChannel = 13;
